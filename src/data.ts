export const DOCTOR_INFO = {
  ...
  title: "Child Healthcare | Adda Gamber",
  ...
  mapUrl: "https://maps.app.goo.gl/qPjQFkpWgSwdZLab7"
};

export const IMAGES = {
  hero: "https://i.ibb.co/RkYq5Ytx/Whats-App-Image-2026-08-09-at-8-21-20-AM.jpg",
  gallery: [
...
export const VIDEOS = [
  { id: "v9uwmn", title: "Clinic Overview", description: "A brief look at our clinic facilities in Adda Gamber." },
...
export const FAQS = [
  ...
  { question: "How many years of experience does the doctor have?", answer: "The doctor has over 20+ years of experience in treating children's diseases in Gamber and Okara." },
  ...
  { question: "Where is the clinic located?", answer: "The clinic is located in Adda Gamber." },
  ...
  { question: "How can I get directions to Adda Gamber?", answer: "You can click the 'Get Directions' button on our location section to open the exact location in Google Maps." }
];
