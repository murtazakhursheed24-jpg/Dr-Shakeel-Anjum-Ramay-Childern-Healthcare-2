...
export const VIDEOS = [
  { id: "v9uwmn", title: "Clinic Overview", description: "A brief look at our clinic facilities." },
  { id: "eupram", title: "Child Health Care", description: "Understanding the importance of early childhood checkups." },
...
export const FAQS = [
  ...
  { question: "Where is the clinic located?", answer: "The clinic is located at Al Shifa Children and Maternity Home, Gamber, Pakistan." },
